...
const NumberInput: FC<NumberInputProps> = ({
	...
	return (
		<div
			className={
				focused
					? containerClasses.join(" ") + " " + styles.focused
			...
			<div
				className={
					focused
						? styles.numberInputDisplay + " " + styles.focused
						: styles.numberInputDisplay
				}>
				{current}
			</div>
...
const NumberInputArrow: FC<NumberInputArrowProps> = ({
	direction,
	onClickHandler,
}) => {
	const [focused, setFocus] = useState(false);
	...
	var points =
		direction == "up"
			? "406.5 207 207 7.5 7.5 207"
			: "406.5 7.5 207 207 7.5 7.5";

	return (
		<svg
			className={
				focused
					? styles.numberInputArrow + " " + styles.focused
					: styles.numberInputArrow
			}
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 414 214.5"
